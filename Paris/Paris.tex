...
in a disgusting slum, whose name,\\
{\em Mission Universitaire Française,}\\
did not advertise the common bedroom, smelly\\
of bodies crammed into hammocks.\\
But we were twenty,\\
even that sleepless night in the barracks,\\
we found romantic.
\end{stanza}
\begin{stanza} 
Then a week, longer \\
...
talking about ART,\\
with the capitals letters of youth.
\end{stanza}
\begin{stanza}
Yes, and the fancy coloured tubes,\\
bright and fuzzy, like a Kandinsky's,\\
crossing the facade of the museum, evoking\\
the illusion of false factory, as if a dream.
\end{stanza}
\begin{stanza}
...
as the stalls of old booksellers,\\
...
just for us. It didn’t cross my mind, how cliché was,\\
...
repeated by the poets and the singers,\\
...
%\end{stanza}
\begin{stanza} 
You did not visited either the second city,\\
...
the ocasional stolen sandwich, playing bohemian,\\
...
it could have been Viena, or Rome, Tel Aviv or Prague,\\
...
each one piling above the previous,\\
ordered in time, like archeological layers,\\
and at the same time overlapping,\\
as if they were made of mist.
\end{stanza} 
\begin{stanza} 
You return to Paris so often across the years,\\
...
there is among both of you the intimacy,\\
...
\end{stanza} 
\begin{stanza} 
So she is taking care of you, firmly, \\
holding your hand. But your son's grip,\\
...
absorbing equally land and people,\\
...
sparks flew the night. 
\end{stanza}
\begin{stanza} 
Now, if you are not careful,\\
you will be taken by a loony,\\
or worst, a lecher. \\
...
Your daughter is twenty, still holds you hand,\\
talks non-stop about her recent love-boy,\\
he is coming to meet her,\\
they will walk the same streets,\\
and kiss in the same corners,\\
that one smiled at you,\\
...
want to be a scientist like mom and dad,\\
when he was small,\\
he wanted to work in the same place, \\
that both of you, now,\\
...
\begin{poem}
\begin{stanza}
The clochard who sleeps under the doorway\\
of that building in the Montparnasse boulevard,\\
...
over the grids of the subway venting grids,\\
barefoot, whitebearded, a bottle of vodka at hand,\\
...
\begin{stanza}
Nearby the tourists,\\ 
expend the money he need to survive a full month,\\
in a ticket to the modernist museum.
\end{stanza}
\end{poem}
\end{document}